<div class="box">
    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-sm-4">
                <?=form_open('jenjangkelasmatpel/save', array('id'=>'jenjangkelasmatpel'), array('method'=>'add'))?>
                <div class="form-group">
                    <label>Mata Pelajaran</label>
                    <select name="matpel_id" class="form-control select2" style="width: 100%!important">
...
<script src="<?=base_url()?>assets/dist/js/app/relasi/jenjangkelasmatpel/add.js"></script>