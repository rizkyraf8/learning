<div class="box">
    ...
    <div class="box-body">
        <ul class="alert alert-info" style="padding-left: 40px">
            ...
            <li>Untuk data Mata Pelajaran, hanya bisa diisi menggunakan ID Mata Pelajaran. <a data-toggle="modal" href="#matpelId" style="text-decoration:none" class="btn btn-xs btn-primary">Lihat ID</a>.</li>
        </ul>
                            ...
                            <?php
                                ...
                                if (empty($import)) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="<?= $data['matpel_id'] == null ? 'bg-danger' : ''; ?>">
                                            <?= $data['matpel_id'] == null ? 'BELUM DIISI' : $data['matpel_id'];; ?>
                                        </td>
                                    </tr>
                            <?php
                                        if ($data['nip'] == null || $data['nama_guru'] == null || $data['email'] == null || $data['matpel_id'] == null) {
                                            $status = false;
                                        }
                                    endforeach;
                                }
...
<div class="modal fade" id="matpelId">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table id="matpel" class="table table-condensed table-striped">
                    <thead>
                        <th>ID</th>
