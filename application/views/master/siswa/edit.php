        ...
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                <?=form_open('siswa/save', array('id'=>'siswa'), array('method'=>'edit', 'id_siswa'=>$siswa->id_siswa))?>
                    ...
                    <div class="form-group">
                        <label for="jenjangkelas">Jenjangkelas</label>
                        <select id="jenjangkelas" name="jenjangkelas" class="form-control select2">
                            <option value="" disabled selected>-- Pilih --</option>
                            <?php foreach ($jenjangkelas as $j) : ?>
                            <option <?=$siswa->id_jenjangkelas === $j->id_jenjangkelas ? "selected" : "" ?> value="<?=$j->id_jenjangkelas?>">
                                <?=$j->nama_jenjangkelas?>
                            </option>
                            <?php endforeach ?>
                        </select>
