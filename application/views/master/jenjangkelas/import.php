<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="text-center">
            <a href="<?= base_url('uploads/import/format/jenjangkelas.xlsx') ?>" class="btn-default btn">Download Format</a>
        </div>
        <br>
        <div class="row">
            <?= form_open_multipart('jenjangkelas/preview'); ?>
            ...
            <div class="col-sm-6 col-sm-offset-3">
                <?php if (isset($_POST['preview'])) : ?>
                        ...
                        <tbody>
                            <?php
                                if (empty($import)) {
                                    ...
                                    $no = 1;
                                    foreach ($import as $jenjangkelas) :
                                        ?>
                                    <tr>
                                        <td><?= $no++; ?></td>
                                        <td><?= $jenjangkelas; ?></td>
                    ...
                    <?php if (!empty($import)) : ?>
                        ...
                        <?= form_open('jenjangkelas/do_import', null, ['jenjangkelas' => json_encode($import)]); ?>
