<div class="box">
    ...
    <div class="box-body">
		<div class="mt-2 mb-4">
            ...
            <a href="<?=base_url('jenjangkelas/import')?>" class="btn btn-sm btn-flat btn-success"><i class="fa fa-upload"></i> Import</a>
        ...
        <table id="jenjangkelas" class="w-100 table table-striped table-bordered table-hover">
            <thead>
                <tr>
                    <th>No.</th>
                    <th>Jenjang</th>
...
<div class="modal fade" id="myModal">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
            ...
            <?=form_open('jenjangkelas/add', array('id', 'tambah'));?>
...
<script src="<?=base_url()?>assets/dist/js/app/master/jenjangkelas/data.js"></script>